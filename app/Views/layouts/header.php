...
<div class="nav-header">
	<a href="index.html" class="brand-logo">
		<img src="<?= base_url() ?>assets/imagens/logo-sem-legenda.png" width="45" alt="">
		
		<div class="brand-title">
			<h2 class="">Infoassessor</h2>
				...
				<ul class="navbar-nav header-right">
					...
					<li class="nav-item dropdown notification_dropdown">
						...
						<div class="dropdown-menu dropdown-menu-end">
										...
										<div class="timeline-panel">
											<div class="media me-2">
												<img alt="image" width="50"
												     src="<?= base_url() ?>xhtml/images/avatar/1.jpg">
											</div>
											<div class="media-body">
												<h6 class="mb-1">Nova notificação</h6>
												<small class="d-block">29 Janeiro 2023 - 14:26</small>
											</div>
										</div>
									</li>
							...
							<a class="all-notification" href="javascript:void(0);">Todas as Notificações <i
					...
					<li class="nav-item dropdown  header-profile">
						<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
							<img src="<?= base_url() ?>xhtml/images/user.jpg" width="56" alt=""/>
						</a>
						<div class="dropdown-menu dropdown-menu-end">
							<a href="javascript:;"
							   onclick="abrir_div('<?= base_url() ?>usuario/alterarSenha','container',1)"
							...
							<a href="<?= base_url() ?>login/sair" class="dropdown-item ai-icon">
